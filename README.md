# Unity Game's Screenshot & Record Blocker
A plugin known to prevent screenshots and recording of your Unity game.

<p>
Stops the ability to screenshot or record your Unity game in <strong>most</strong> softwares. This plugin is useful if you have beta testers in your game and don't want them to record or capture any gameplay in your game.<br>
It could also be useful for preventing any sensitive information (according to your game) from being leaked.<br>
PLEASE BE AWARE THIS DOES NOT WORK 100% OF THE TIME!<br>
...
```
You can include this anywhere at runtime, commonly at Start() or Awake().
